...
const vec3 skyCol     = HSV2RGB(vec3(hoff+0.5, 0.86, 1.0));
const vec3 diffuseCol = HSV2RGB(vec3(hoff+0.0, 0.0, 0.0));
...
vec3 skyColor(vec3 ro, vec3 rd) {
  vec3 skyCol     = HSV2RGB(vec3(time/60.0, 0.5, 1.0));
...
vec3 render(vec3 ro, vec3 rd) {
  ...
  for (int bounce = 0; bounce < MAX_BOUNCES; ++bounce) {
    ...
    vec3 beer       = -HSV2RGB(vec3(time/59.0, 0.5, 2.0));
...
vec3 effect(vec2 p) {
  ...
  vec3 ro = 0.6*vec3(cos(TIME/12)*5.0, cos(TIME/12)*1.0 + 1.0, sin(TIME/12)*5.0);
